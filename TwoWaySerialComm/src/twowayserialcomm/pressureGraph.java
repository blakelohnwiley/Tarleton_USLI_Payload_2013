 ...
 * @author John
 */
public class pressureGraph extends JPanel {
    ...
    public pressureGraph() {
        ...
        series = new TimeSeries("Pressure", Second.class);
       ...
       // dataset.addSeries(series);
        ...
        plot.getRangeAxis().setRange(-10.0,40.0);
    ...
    public void paintComponent(Graphics g){
       // series.add(x,x*x); 
        if(TwoWaySerialComm.pressure != 0){
            pressure = (float)TwoWaySerialComm.pressure/10;
            series.addOrUpdate(new Second(new Date()),pressure * 0.002952998);
        }
        //dataset.addSeries(series);
